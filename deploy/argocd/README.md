...
- **Kubernetes cluster with infrastructure components installed:**
  - **Recommended:** Use the Terraform infrastructure from `../../terraform/`
  - Run `terraform apply` followed by `terraform/scripts/install-k8s-components.sh` 
  - This automatically installs: ingress-nginx, cert-manager, and ArgoCD
- kubectl configured to access your cluster
- Git repository access (https://github.com/wesback/fluxion)
- Optional: ArgoCD CLI for command-line operations

> **💡 Quick Path:** If you used Terraform with the bootstrap script, ArgoCD is already installed 
> and you can skip to [Project Setup](#project-setup)!
...
If ArgoCD is not already installed via the Terraform bootstrap script:
