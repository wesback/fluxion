...
**Project:** fluxion
Linux package-update tracking with APT hooks, a FastAPI/Python/PostgreSQL backend, a Next.js/React dashboard, and Azure AKS delivery via Terraform, Helm, and ArgoCD.
