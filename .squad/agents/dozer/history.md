...
- Dozer owns API auth, secrets, RBAC, OpenTelemetry, and production hardening.
- APT-hook and package-update data requires secure ingestion and observable processing.
