...
- Trinity owns FastAPI, SQLAlchemy, PostgreSQL, migrations, and webhooks.
- Backend contracts should keep APT-hook ingestion and dashboard status views consistent.
