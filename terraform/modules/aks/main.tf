resource "azurerm_kubernetes_cluster" "main" {
  ...
  # Note: The `managed = true` field is deprecated but currently required for AKS-managed Entra integration.
  # It will be defaulted to `true` in AzureRM provider v4.0. See: https://aka.ms/aks/aad-legacy
